...
public class ServiceAuthUtil {
	...
	public void refreshAllowedClient() {
		...
		BaseResponse resp = serviceAuthFeign.getAllowedClient(serviceAuthConfig.getClientId(),
	...
	public void refreshClientToken() {
		...
		BaseResponse resp = serviceAuthFeign.getAccessToken(serviceAuthConfig.getClientId(),
				serviceAuthConfig.getClientSecret());
		if (resp.getStatus() == 200) {
